...
def policy_evaluation(P, nS, nA, policy, gamma=0.9, tol=1e-3):
	...
	#1. Initialize v0(s) to all 0s
	#2. While you are not converged
	#3. For current state in the set of all states
	#4. vk+1(s) is equal to big math equation which you can get from P
